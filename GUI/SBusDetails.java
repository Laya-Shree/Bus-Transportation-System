...
public class SBusDetails extends javax.swing.JFrame {
    ...
    private void btnBackActionPerformed(ActionEvent evt) {
     ...
     public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SBusDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SBusDetails().setVisible(true);
            }
        });
